...
function GlobalParticles({ activeShape, mousePos }: { activeShape: ShapeType, mousePos: { x: number, y: number } | null }) {
...
export function BracketsSection() {
    ...
    return (
        ...
        >
            ...
            <GlobalParticles activeShape={activeShape} mousePos={centerPos} />
